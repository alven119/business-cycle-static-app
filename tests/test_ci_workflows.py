...
def test_ci_closure_helper_contains_expected_closure_bundles() -> None:
    ...
    required_snippets = [
        ...
        "show_phase138_nyfed_sce_dashboard_integration_closure.py",
        "show_phase133_historical_transition_policy_timeline_closure.py",
        "show_phase132_phase_aware_dashboard_closure.py",
        "show_phase131_historical_pit_transition_events_closure.py",
        "show_phase130_full_cycle_revised_data_closure.py",
    ...
    assert "scripts/show_phase138_nyfed_sce_dashboard_integration_closure.py" in (
        FULL_CLOSURE_SCRIPTS
    )
    assert "scripts/show_phase137_nyfed_sce_components_closure.py" in (
        NIGHTLY_CLOSURE_SCRIPTS
    )
    assert "scripts/show_phase136_consumer_confidence_sources_closure.py" in (
        NIGHTLY_CLOSURE_SCRIPTS
    )
    assert "scripts/show_phase135_source_incident_center_closure.py" in (
        NIGHTLY_CLOSURE_SCRIPTS
    )
