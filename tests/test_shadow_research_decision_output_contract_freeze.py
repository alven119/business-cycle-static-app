...
def test_alpha20_research_decision_output_contract_freeze_is_valid() -> None:
    summary = summarize_shadow_research_decision_output_contract_freeze()

    assert summary["research_decision_output_contract_freeze_ready"] is True
    assert summary["freeze_id"] == "book_faithful_shadow_v2_alpha20"
    assert summary["parent_freeze_id"] == "book_faithful_shadow_v2_alpha19"
