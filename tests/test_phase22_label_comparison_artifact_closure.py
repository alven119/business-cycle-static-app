...
def test_phase22_label_comparison_artifact_closure_passes() -> None:
    summary = summarize_phase22_label_comparison_artifact_closure()
    ...
    assert summary["development_next_phase"] == 23
    assert summary["phase22_closure_status"] == (
        "closed_label_comparison_artifacts_generated_no_metrics"
    )
