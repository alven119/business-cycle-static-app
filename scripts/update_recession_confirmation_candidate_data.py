"""Update local raw cache for recession confirmation candidate FRED series."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Update FRED cache for experimental candidate indicators.")
