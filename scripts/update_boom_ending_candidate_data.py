"""Update local raw cache for boom-ending candidate FRED series."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Update FRED cache for boom-ending candidate indicators.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        summary = update_candidate_fred_cache(
            ...
            spec_loader=load_boom_ending_candidate_indicators,
            summary_label="candidate boom ending cache update",
