...
FULL_CLOSURE_SCRIPTS = (
    ...
    "scripts/show_phase137_nyfed_sce_components_closure.py",
    "scripts/show_phase125_strict_replay_backtest_closure.py",
...
NIGHTLY_CLOSURE_SCRIPTS = (
    ...
    "scripts/show_phase135_source_incident_center_closure.py",
    "scripts/show_phase134_release_aware_source_identity_closure.py",
    "scripts/show_phase133_historical_transition_policy_timeline_closure.py",
    "scripts/show_phase132_phase_aware_dashboard_closure.py",
    "scripts/show_phase131_historical_pit_transition_events_closure.py",
    "scripts/show_phase130_full_cycle_revised_data_closure.py",
    "scripts/show_phase129_governed_cycle_transition_closure.py",
    "scripts/show_phase128_full_cycle_portfolio_page_completion_closure.py",
    "scripts/show_phase127_prospective_calendar_gate_closure.py",
    "scripts/show_phase126_nas_v1_operational_acceptance_closure.py",
    "scripts/show_phase125_strict_replay_backtest_closure.py",
    "scripts/show_phase124_portfolio_replay_lab_closure.py",
    "scripts/show_phase123_live_ordered_cycle_evidence_closure.py",
    "scripts/show_phase122_technology_manufacturing_cycle_closure.py",
    "scripts/show_phase121_indicator_transformation_learning_closure.py",
    "scripts/show_phase120_cycle_command_center_closure.py",
