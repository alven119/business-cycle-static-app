"""Check local coverage for recovery candidate FRED series."""
...
from business_cycle.backtests import (  # noqa: E402
    ...
    check_recovery_candidate_coverage,
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Check local raw cache coverage for recovery candidates.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        summary = check_recovery_candidate_coverage(spec_path=args.spec, cache_dir=args.cache_dir)
