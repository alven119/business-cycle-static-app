"""Phase 24 research decision output contract closure."""
...
DEFAULT_PHASE24_CLOSURE_PATH = Path(
    "specs/audits/phase24_research_decision_output_contract_closure.yaml"
)
PROSPECTIVE_NEXT_ACTION = "WAIT_FOR_FIRST_ELIGIBLE_AS_OF"
CLOSURE_STATUS = "closed_research_decision_output_contract_preregistered_no_emission"


def summarize_phase24_research_decision_output_contract_closure(
    path: str | Path = DEFAULT_PHASE24_CLOSURE_PATH,
) -> dict[str, Any]:
    expected = _load_expected(path)
    readiness = summarize_historical_research_decision_output_readiness()
    freeze = summarize_shadow_research_decision_output_contract_freeze()
    phase23 = summarize_phase23_comparison_coverage_metrics_closure()
    ...
    summary = {
        ...
        "deferred_capability_gaps": [
            "research_decision_outputs_not_emitted",
        ...
        "research_decision_output_contract_ready": readiness[
            "research_decision_output_contract_ready"
        ],
        "research_decision_output_readiness_ready": readiness[
            "research_decision_output_readiness_ready"
        ],
        "output_taxonomy_ready": readiness["output_taxonomy_ready"],
        "predicted_label_output_count": readiness["predicted_label_output_count"],
        "research_decision_output_emitted": readiness[
        ...
        "accuracy_metric_enabled": readiness["accuracy_metric_enabled"],
        "economic_performance_metric_enabled": readiness[
        ...
        "alpha20_freeze_hash_valid": freeze["alpha20_freeze_hash_valid"],
        "alpha19_parent_preserved": freeze["alpha19_parent_preserved"],
        ...
        "development_next_phase": 25,
        "prospective_track_next_action": PROSPECTIVE_NEXT_ACTION,
        "phase24_closure_status": CLOSURE_STATUS,
        "project_definition_of_done_progress": (
            "phase24_preregisters_research_decision_output_schema_without_emission"
        ),
        "readiness": readiness,
        "freeze": freeze,
        "phase23_closure": phase23,
        "leakage": leakage,
    }
...
def _passed(summary: dict[str, Any], expected: dict[str, Any]) -> bool:
    ...
    return (
        ...
        and summary["readiness"]["research_decision_output_readiness_ready"] is True
        and summary["freeze"]["research_decision_output_contract_freeze_ready"]
        is True
        ...
        and summary["phase23_closure"]["result"] == "passed"
        and summary["phase23_closure"]["prospective_registry_record_count"] == 0
        and summary["phase23_closure"]["real_registry_write_attempt_count"] == 0
    )
...
def _load_expected(path: str | Path) -> dict[str, Any]:
    return yaml.safe_load(Path(path).read_text(encoding="utf-8"))[
        "phase24_research_decision_output_contract_closure"
    ]["expected"]
