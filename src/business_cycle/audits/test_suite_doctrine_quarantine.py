...
TEST_FILE_MARKER_MAP: dict[str, QuarantineEntry] = {
    ...
    "tests/test_phase50_transition_surface_data_risk_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
    ...
    "tests/test_low_cost_macro_source_completion.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase54 low-cost source completion preserves proxy boundaries",
    ),
    "tests/test_phase54_low_cost_macro_source_completion_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase54 closure proves paid API exclusion and no phase emission",
    ),
    "tests/test_show_phase54_low_cost_macro_source_completion_closure_script.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase54 closure script smoke test remains research-only",
    ),
    "tests/test_macro_indicator_coverage_readiness_matrix.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase55 coverage matrix makes macro gaps visible without phase selection",
    ),
    "tests/test_phase55_macro_indicator_coverage_readiness_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase55 closure proves coverage burn-down remains research-only",
    ),
    ...
    "tests/test_boom_to_recession_transition_surface_completion.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase57 completion surface preserves lane boundaries without phase selection",
    ),
    "tests/test_phase57_boom_to_recession_transition_surface_completion_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase57 closure proves completed transition surface remains research-only",
    ),
    "tests/test_show_phase57_boom_to_recession_transition_surface_completion_closure_script.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
    ...
    "tests/test_declared_phase_start_confirmation.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase69 start confirmation package displays governed windows without registry writes",
    ),
    "tests/test_phase69_declared_phase_start_confirmation_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase69 closure proves dashboard handoff preserves declared state boundaries",
    ),
    "tests/test_declared_phase_start_registry_preview.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase70 registry preview validates user input without registry writes",
    ),
    "tests/test_phase70_declared_phase_start_registry_preview_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
    ...
    "tests/test_transition_risk_evidence_accumulation.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase86 transition risk accumulation view explains evidence buildup without phase selection",
    ),
    "tests/test_phase86_transition_risk_evidence_accumulation_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase86 closure proves transition accumulation stays research-only",
    ),
    ...
    "tests/test_phase60_evidence_freshness_release_value_continuity_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase60 closure proves continuity gates remain research-only",
    ),
    "tests/test_show_phase60_evidence_freshness_release_value_continuity_closure_script.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase60 closure script smoke test remains research-only",
    ),
    "tests/test_major_group_evidence_profile_readiness.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase61 major-group profiles explain readiness without phase selection",
    ),
    "tests/test_phase61_major_group_evidence_profile_readiness_closure.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
        rationale="Phase61 closure proves group profiles stay explanation-only",
    ),
    "tests/test_show_phase61_major_group_evidence_profile_readiness_closure_script.py": QuarantineEntry(
        markers=("doctrine_aligned", "transition_monitor", "governance_scaffold"),
