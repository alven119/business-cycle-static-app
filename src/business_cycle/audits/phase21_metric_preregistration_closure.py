"""Phase 21 historical metric preregistration closure."""
...
DEFAULT_PHASE21_CLOSURE_PATH = Path(
    "specs/audits/phase21_metric_preregistration_closure.yaml"
)
PROSPECTIVE_NEXT_ACTION = "WAIT_FOR_FIRST_ELIGIBLE_AS_OF"
CLOSURE_STATUS = "closed_historical_metrics_preregistered_no_computation"


def summarize_phase21_metric_preregistration_closure(
    path: str | Path = DEFAULT_PHASE21_CLOSURE_PATH,
) -> dict[str, Any]:
    expected = _load_expected(path)
    readiness = summarize_historical_metric_readiness()
    freeze = summarize_shadow_metric_preregistration_freeze()
    phase20 = summarize_phase20_historical_validation_dry_run_closure()
    ...
    summary = {
        ...
        "historical_label_comparison_contract_ready": readiness[
            "historical_label_comparison_contract_ready"
        ],
        "historical_metric_preregistration_ready": readiness[
            "historical_metric_preregistration_ready"
        ],
        "historical_metric_registry_ready": readiness[
            "historical_metric_registry_ready"
        ],
        "metric_readiness_ready": readiness["metric_readiness_ready"],
        "preregistered_metric_count": readiness["preregistered_metric_count"],
        ...
        "alpha17_freeze_hash_valid": freeze["alpha17_freeze_hash_valid"],
        "alpha16_parent_preserved": freeze["alpha16_parent_preserved"],
        "qa12_freeze_unchanged": freeze["qa12_freeze_unchanged"],
        "formal_decision_model_ready": False,
        "candidate_capability_ready": False,
        "economic_validation_status": "metrics_preregistered_no_computation",
        ...
        "development_next_phase": 22,
        "prospective_track_next_action": PROSPECTIVE_NEXT_ACTION,
        "phase21_closure_status": CLOSURE_STATUS,
        "project_definition_of_done_progress": (
            "phase21_preregisters_label_comparison_and_metrics_without_computation"
        ),
        "readiness": readiness,
        "freeze": freeze,
        "phase20_closure": phase20,
        "qa12_closure": qa12,
        "leakage": leakage,
    }
...
def _passed(summary: dict[str, Any], expected: dict[str, Any]) -> bool:
    ...
    return (
        ...
        and summary["readiness"]["metric_readiness_ready"] is True
        and summary["freeze"]["metric_preregistration_freeze_ready"] is True
        ...
        and summary["phase20_closure"]["result"] == "passed"
...
def _load_expected(path: str | Path) -> dict[str, Any]:
    return yaml.safe_load(Path(path).read_text(encoding="utf-8"))[
        "phase21_metric_preregistration_closure"
    ]["expected"]
