...
狀態：已完成。五個情境共有 156 個月度 annotation；NBER chronology 僅作事後標籤，
其中 28 個衰退月可安全連到書籍衰退期 100% 股票研究規則。NBER expansion 不足以拆成
復甦／成長／榮景，因此刻意標為書籍子階段未分類。
...
目前 12 組固定權重比較來自兩個 strict-complete 情境；網路泡沫、GFC 與歐債仍受七條早期
官方 PIT 缺口阻擋。頁面保留 explicit abstention，不使用 revised fallback，也不把歷史結果
回饋轉折規則。Phase 129–133 active engineering roadmap 至此完成；Phase 127 calendar gate
仍依 2026-08-31 與後續未見資料累積獨立運作。
